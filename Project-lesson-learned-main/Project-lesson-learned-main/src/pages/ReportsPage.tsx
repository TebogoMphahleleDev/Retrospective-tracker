...
const ReportsPage = () => {
  ...
  const projectData: ProjectData[] = [
    { id: 1, name: 'Digital Transformation', lessons: 24, positive: 18, negative: 4, neutral: 2 },
    { id: 2, name: 'Product Launch', lessons: 15, positive: 10, negative: 3, neutral: 2 },
    { id: 3, name: 'Process Optimization', lessons: 32, positive: 25, negative: 5, neutral: 2 },
    { id: 4, name: 'Team Restructuring', lessons: 8, positive: 3, negative: 4, neutral: 1 },
  ];
          ...
          <>
            {tabValue === 0 && (
              <Box sx={{
                ...
                <Box sx={{
                  ...
                  <Paper sx={{ p: 3, textAlign: 'center' }}>
                    <Typography variant="h5" sx={{ color: theme.palette.success.main }}>32</Typography>
                    <Typography variant="subtitle2">Positive Impact</Typography>
                  </Paper>
                  <Paper sx={{ p: 3, textAlign: 'center' }}>
                    <Typography variant="h5" sx={{ color: theme.palette.error.main }}>7</Typography>
                    <Typography variant="subtitle2">Negative Impact</Typography>
                  </Paper>
                  <Paper sx={{ p: 3, textAlign: 'center' }}>
                    <Typography variant="h5" sx={{ color: theme.palette.warning.main }}>3</Typography>
                ...
                <Box sx={{
                  ...
                  <Paper sx={{ p: 2, height: '400px' }}>
                    <Typography variant="h6" gutterBottom>Lessons by Project</Typography>
                    {/* Chart placeholder */}
                    <Box sx={{ 
                      height: '100%', 
                      display: 'flex', 
                  ...
                  <Paper sx={{ p: 2, height: '400px' }}>
                    <Typography variant="h6" gutterBottom>Lessons by Category</Typography>
                    {/* Chart placeholder */}
                    <Box sx={{ 
                      height: '100%', 
                      display: 'flex', 
            ...
            {tabValue === 1 && (
              <Paper sx={{ p: 2, height: '500px' }}>
                <Typography variant="h6" gutterBottom>Project Analysis</Typography>
                {/* Chart placeholder */}
                <Box sx={{ 
