...
const LessonCard = styled(Card)<LessonCardProps>(({ theme, impact }) => ({
  ...
  borderLeft: `4px solid ${
    impact === 'positive' ? theme.palette.success.main : 
    impact === 'negative' ? theme.palette.error.main : 
  ...
  return (
    <Box sx={{ 
              ...
              <CardContent>
                <Box sx={{ 
                  ...
                  <Chip 
                    ...
                    size="small"
                    color={
                      lesson.category === 'Business Process' ? 'default' :
                      lesson.category === 'Project Management' ? 'primary' : 'secondary'
                    }
                  />
                  <Typography 
                    variant="caption" 
                ...
                <Box sx={{ 
                  ...
                  <Box sx={{ display: 'flex', alignItems: 'center' }}>
                    ...
                    <Typography variant="caption" sx={{ ml: 0.5 }}>
                      {lesson.impact === 'positive' ? 'Positive' : 
                       lesson.impact === 'negative' ? 'Negative' : 'Neutral'} Impact
                    </Typography>
                  </Box>
      ...
      <Box sx={{ display: 'flex', justifyContent: 'center', mt: 4 }}>
        <Paper sx={{ p: 1 }}>
          <Button disabled sx={{ mx: 1 }}>Previous</Button>
          <Button variant="contained" sx={{ mx: 1 }}>1</Button>
